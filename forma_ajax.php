...
?>
<form id="abc" method="get" action="/index.php">
...
<?php if (isset($_GET['with'])) { ?>
    <?php if (in_array("ingredient", $_GET['with'])) { ?>
        <label><?php echo ucfirst(trim($cl['sastojci'])); ?>: </label><br>
        <input type="text" name="ingredients" <?php if (isset($_GET['ingredients'])) { ?>
                                                              value="<?php echo $_GET['ingredients'];
                                                              } ?>"><br>
    <?php } ?>
    <?php if (in_array("cat", $_GET['with'])) { ?>
        <label><?php echo ucfirst(trim($cl['kategorija'])); ?>: </label><br>
        <input type="text" name="category" <?php if (isset($_GET['category'])) { ?>
    ...
    <?php if (in_array("tag", $_GET['with'])) { ?>
        ...
        <label>Tag: </label><br>
        <input type="text" name="tags" <?php if (isset($_GET['tags'])) { ?> value="<?php echo $_GET['tags'];
        }
        ?>"><br>
    <?php } ?>
<?php } ?>
